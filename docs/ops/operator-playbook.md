...
| **D-1** | Thu 04-30 | (a) Streak tracking issue is **already filed: [#195](https://github.com/palimkarakshay/lumivara-site/issues/195)** (pinned). Open it once, confirm the counter is at 0/10. (b) Walk every open issue and apply `priority/` × `complexity/` × `area/` triples or close as `status/post-migration`. **Sub-pass landed 2026-04-30 (PM Claude session):** 20 `status/awaiting-review` items closed against their already-merged feedback PRs (#7, #12, #13, #16, #22, #32, #45, #107, #117, #143, #178, #180, #208, #209, #211, #212, #213, #215, #216, #217). Inbox (`status/needs-triage`) and no-status sweeps both ran the same day: inbox is empty; the 6 no-status items (#243, #188 rolling dashboards; #193 audit-blocker; #163 active feature; #67/#68 bundled multi-asks partially overlapping #72) are all justified to stay open — none done/duplicate in a way that warrants auto-close. Triple-classification + project-board pass on the residual 40 items still operator-owed. (c) **Same sitting:** fill the `Repo-Destination-Post-Migration` field on every project item ([`github-project-layout.md §6.2`](./github-project-layout.md#62--the-single-most-important-bulk-classification-pass)). | 90 min | ◐ |
