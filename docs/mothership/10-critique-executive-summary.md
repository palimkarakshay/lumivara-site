<!-- OPERATOR-ONLY. External review of 00–09. -->
...
| 5 | **Action-minutes maths doesn't reconcile** — `04` budgets 250 min/T2 client/mo; `09` claims 25 T2 clients fit in the 2,000-min Free tier (= 6,250 min, 3× over). | 🟠 High | `04 §1`, `09 §1` | `13 §1` |
| 6 | **AI cost numbers don't reconcile** — `cost-analysis 03` Part D shows $280 USD/mo at 25 clients, but the only listed plan above $200 is "hire a second seat." | 🟠 High | `freelance/03` | `13 §2` |
