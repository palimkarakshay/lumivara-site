...
export const faqs: FAQ[] = [
  ...
  },
  {
    ...
    answer:
      "Lumivara operates as a boutique consulting partner, which allows for a more focused, hands-on approach. Unlike larger firms that often apply standardized frameworks, Lumivara designs approaches that are fully tailored to each organization's context, challenges, and goals. This means greater flexibility, deeper engagement, and approaches that are more practical, relevant, and effective in real-world implementation.",
  },
  {
    id: "pricing",
