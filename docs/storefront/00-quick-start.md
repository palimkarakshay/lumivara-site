...
| "Why pay monthly?" | Because every other developer charges per-edit and disappears between projects. Show them the cost-comparison table in `04-slide-deck.md` slide "What it costs at lumivara-forge.com vs. the alternatives." |
