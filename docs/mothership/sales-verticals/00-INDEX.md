...
**Cross-stakeholder rebuttal (operator-only).** [`00b-why-this-sells.md`](./00b-why-this-sells.md) — the inversion-companion to `00a`. Where `00a` answers *"what we won't sell, and why a prospect's vendor will lie about it"*, `00b` answers *"given that negative list and every honest drawback in `../../research/06-drawbacks-and-honest-risks.md`, why does this still sell — and why does it fix an itch every alternative has left unscratched?"*. Audience-keyed across five lenses (advisor / investor / prospective-client / partner / employee). Surfaces externally as the "Why this sells / itch that never scratches" slide cluster in `../../decks/06`, `06a`, `01`, `04`, and the sharpened Contested-claim 6 in `../../decks/05`. Read this before any pressure-test conversation with a senior advisor and before any first call where the conversation is likely to land on *"but your competitor does X."*
