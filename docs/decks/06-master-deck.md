...
## Why our negative list is detailed — the things competitors lie about

Operator-pitch reference: every promise below is what a competitor in *some* vertical has tried to sell our prospects in the last 6 months. Each is a regulator-citable failure, a platform-TOS-citable failure, or both. Source-of-truth reasoning lives in `docs/mothership/sales-verticals/00a-negative-list-rationale.md`; the slide-level detail per vertical lives in `docs/decks/vertical-pitches/<vertical>.md`.

| Promise we will not make | Why we will not make it | What we sell instead |
|---|---|---|
| **"Guaranteed first-page Google ranking."** | (a) Every vertical regulator we sell under prohibits ranking guarantees as unsupported comparative / outcome claims (CPSO §2 *Advertising*; RCDSO §6; LSO §4.2; CPA Ontario Rule 402; COO; College of Physiotherapists). (b) Google *Search Essentials* state plainly no SEO firm can guarantee a ranking. (c) AI Overviews / AI Mode / ChatGPT / Perplexity are now answering a meaningful share of informational queries before any click — "rank #1" thinking is already obsolete. | Core Web Vitals ≥ 90 mobile, JSON-LD schema for the entities Google + AI Overviews quote, WCAG 2.1 AA accessibility, 301-redirect map at migration, content freshness from owner dictation. Bundled into the monthly improvement run; no separate "SEO retainer" line. |
| **"Public-facing AI chatbot / receptionist."** | A bot that doesn't know the licensee's scope-of-practice generates clinical / legal / financial advice the licensee carries the liability for. *Moffatt v. Air Canada* (2024 BCCRT 149) made the precedent explicit. Privilege exposure (legal); covered-entity scope (healthcare); unauthorised-practice exposure (accounting / optometry). | AI lives operator-side, in the editorial pipeline. The public site has real Book Now / Contact buttons. The AI never speaks to a customer; it speaks only to us. |
| **"Set-and-forget content marketing — we'll write your blog under your name."** | Google E-E-A-T (Quality Rater Guidelines, 2023 *Helpful Content Update* now folded into core ranking) explicitly demotes ghost-written content without verifiable expert authorship. Vertical regulators penalise unsupported professional claims. The licensee carries the malpractice exposure for vendor-fabricated text. | Owner dictates (15-second voice memo or paragraph). Pipeline structures, schemas, and ships. Owner is the genuine author; pipeline is the typist. 3–5 dictated content shipments per month. |
| **"X qualified leads per month, guaranteed."** | We don't control demand. Vendors who guarantee lead volumes either (a) define "qualified" so loosely that any form-fill counts, or (b) hit the number by buying paid ads on the licensee's dime. By the time the licensee notices, they've paid 6 months of retainer. | Structural conversion. We tell the licensee what their conversion was last month, where the drop-off is, and what experiment to run next. Demand-generation is a separate vendor relationship; we refer. |
| **"Reputation management — we'll filter unhappy customers."** | Review-gating violates Google *Review Policies* (explicit prohibition), FTC *Endorsement Guides* (2024 final rule, monetary penalties), Canadian *Competition Act* §52 / §74.01 (Bureau enforcement), Yelp *Don't Ask for Reviews* (Consumer Alert badge), and every vertical regulator's advertising rules. | Honest review collection — neutral post-visit invite, no filtering. Typical lift: 3–6× monthly review volume in the first quarter, without any of the legal / platform-policy risk. |
| **"All-in-one — your website, scheduling, EMR, CRM, in our platform."** | Becoming the EMR / case-management / PMS provider means becoming a HIPAA / PHIPA / PIPEDA / SOX / FINTRAC covered entity. We deliberately stay outside that scope. The walled-garden pattern is also the textbook vendor-lock-in play; we refuse to introduce that captivity. | Deep integration. Buttons / webhooks / deep-links into the licensee's existing EMR / case-mgmt / PMS / CRM. The licensee keeps their tool relationship; we keep ours. |
| **"We'll run your Google Ads / Meta Ads on retainer."** | Different skill, different vendor incentives, structural conflict with a clean retainer (ratchets vs. fixed). Bundling ad-spend in a retainer creates an incentive to over-spend on ads (justify retainer) or under-spend (preserve margin); both serve the vendor, not the licensee. | Refer to a partner ads agency, non-revenue-share. Share landing-page conversion data; the agency runs the ad account; the licensee pays the agency directly. |
| **"Buy backlinks / domain authority injection / link networks."** | Google spam policies (manual penalty risk), and a 6-month half-life on the result. We have seen ~30% of migrated sites carry residual penalty signal from a previous vendor. | None. We say no. The migration plan includes a Google Search Console audit for residual-penalty signals. |
| **"Equity-only or revenue-share engagement."** | Operator economics distort under equity entanglement; the cash-retainer model is what aligns incentives cleanly. The "if we go away" exit test fails under equity. | Cash retainer. Clean exit on 30 days' notice. The licensee's domain, code, hosting, content stay with the licensee. |

The negative list is not scope shrinkage — it is a list of *what every competitor in your vertical will lie to you about, and what we are giving you a structural alternative to.* Prospects who hear it and feel relief are buyers. Prospects who hear it and feel withholding are not, and we don't want them.
