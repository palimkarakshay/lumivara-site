...
Two decks already exist in `docs/freelance/`:
...
1. `docs/freelance/06-positioning-slide-deck.md` — operator's own internal answer
...
- [ ] Pricing matches the current `docs/freelance/02-pricing-tiers.md` table.
