...
- The GitHub App identity replacing the legacy `VENDOR_GITHUB_PAT` (per [`docs/mothership/02b §3`](../docs/mothership/02b-dual-lane-architecture.md) and [`12-critique-security-secrets.md §4`](../docs/mothership/12-critique-security-secrets.md)).
...
- **Dual-Lane Repo lane discipline:** never edit operator-only paths from a Site-lane PR (see the rule table in [`AGENTS.md`](../AGENTS.md) and the §6 audit gate in [`scripts/dual-lane-audit.sh`](../scripts/dual-lane-audit.sh)).
...
- [`docs/mothership/02b-dual-lane-architecture.md`](../docs/mothership/02b-dual-lane-architecture.md) — canonical Dual-Lane Repo statement.
